...
产出 `lab/context/research/kb-iteration-research.md`(结论优先,≤300 行),回答:
...
3. `lab/context/research/v07-peak-mechanism.md`(**权威**:峰为何隐形——知识该补哪)。
4. `lab/context/research/v06-backtrack-analysis.md` + `frontier-landscape-synthesis.md`(定位)。
...
- **允许写范围**:仅 `lab/context/research/kb-iteration-research.md`(+ 你自己 worktree 内的临时分析脚本,不进产品树)。
...
- `lab/context/research/kb-iteration-research.md`(结论优先,现状/候选/打分/落地/批判,≤300 行)。
