...
| `lab/reports/workflow-v1.1/report.md` §④ | LLM 接入后变差的阴性对照,本任务的对立证据 |
...
- `lab/reports/` 下任何既有 metrics / events / figures —— **不重跑、不覆盖**
...
本仓在 `lab/context/research/v07-constructive-conclusion.md` 里已明确警告过
...
- `lab/tasks/<本任务>/artifacts/smoke-1seed.md`:1 seed 冒烟证据 +
...
4. 自己 diff `lab/reports/`,确认没有任何既有产物被改动。
