...
## Required Reading
1. `lab/context/research/AI4S-assignment.md`: 明度数智官方 8 大章节考核规范与加分项标准；
2. `lab/reports/final-report-v0.2/report.md`: 既有 8 章基础文本（事实与基线数据来源）；
3. `reports/explainer_for_humans.html`: 详尽的理论推导、数学证明、因果归因与 12 大问答；
4. `lab/context/research/frontier-landscape-synthesis.md`: 国际 2024~2026 前沿学术文献综述；
...
- 核心写入：`lab/tasks/task_ee0e0b26e540664dac1e6c3f29-scientific-report-v0-3/artifacts/`, `lab/reports/final-report-v0.3/`, `reports/`
...
- 主答卷：`lab/reports/final-report-v0.3/report.md`
- 补充思考：`lab/reports/final-report-v0.3/supplementary_thinking_report.md`
- 双仓同步：镜像至 `protein-directed-evolution-agent/reports/`
- 任务材料工件：`lab/tasks/task_ee0e0b26e540664dac1e6c3f29-scientific-report-v0-3/artifacts/` 下 4 份完整学术底本。
