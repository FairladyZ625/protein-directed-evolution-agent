...
- 契约结论与四层根因:`lab/tasks/task_feb731c779788be5bfff65e979-v0-9/artifacts/contract-2x2-seed42.md`
...
v0.9 契约已合入(`377a614`),四臂数据已归档(`lab/reports/v09-contract/`)。
...
- 新数据落 `tmp/` 与新的 `lab/reports/<线>-v<版本>/`,不覆盖已有四臂
- 每个新行为都要守护测试 + 反向验证
