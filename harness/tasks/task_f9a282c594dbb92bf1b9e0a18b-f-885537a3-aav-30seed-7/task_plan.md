...
- 数据源:`harness/context/research/v07-multiseed-robustness.md` 的完整表(含 † 标注的无效 CI)。
...
1. `harness/context/research/v07-multiseed-robustness.md`(**权威**:所有新数字)。
2. `reports/figures/figure-generation-summary.md`(**权威**:现有管线与已修问题)。
3. `scripts/figures/generate_all.py` + `verify_figures.py`(**待改主体**)。
4. `harness/context/research/v07-consolidated-summary.md` 第 1、4 节(定性与边界)。
