...
- 发现来源:`harness/context/research/kb-iteration-research.md`(fact `F-159073F2`),该文档同时盘点了现有 KB 到底编码了什么。
...
1. `harness/context/research/kb-iteration-research.md`(**权威**:现状盘点与问题定位)。
