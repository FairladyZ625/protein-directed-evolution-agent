...
- harness/reports/ 下 agentic 各版本 metrics 与事件链可重放,v0.6/v0.7 的反事实复核全部基于该事件流
- 诚实负结果被 harness/context/research/v07-consolidated-summary.md 第 2 节采纳为自我纠错弧的起点
- 模型标注不一致由 v0.7 红队线(harness/context/research/v07-redteam-critique.md 同批审计)发现,已列入最终报告待改清单
