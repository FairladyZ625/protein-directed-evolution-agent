...
Evidence: artifact:harness/reports/pkgA-mainline-truth/report.md:四项改前改后、 Yen、测试与数值对比
...
Evidence: artifact:harness/reports/pkgA-mainline-truth/report.md:四项状态、ESM停线、数值变化与rebase证据
