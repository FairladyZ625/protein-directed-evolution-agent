...
Evidence: report:harness/reports/pkgB-eval-protocol/report.md:四角色协议、一次 holdout 结果与 HD 分组结论
Evidence: artifact:harness/reports/pkgB-eval-protocol/mutation_order.json:72 条 query-test 提名与未四舍五入指标
...
Evidence: gate:harness/tasks/task_51297081bf4eeb7e466da8a3e1-b-validation-hd1-2-3/closeout.md:submit 被 rewrite-ci.yml 404 阻断
