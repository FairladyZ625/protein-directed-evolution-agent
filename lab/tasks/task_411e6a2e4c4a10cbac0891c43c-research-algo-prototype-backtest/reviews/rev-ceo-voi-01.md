...
- 口径交叉核对:9533 门内候选数与 lab/context/research/kb-iteration-research.md、v07-multiseed-robustness.md 一致
- 负结果与 lab/context/research/v07-redteam-critique.md 的 target-substitution 一击同源且互证
