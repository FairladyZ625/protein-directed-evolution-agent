...
产物版本:`lab/reports/analysis-v0.1/`。与突变阶数分析同属分析线首版,各写自己的文件。
...
- `lab/context/research/plateau-breaking-methods.md` 族 1(为什么 zero-shot 对本题是反指标)
...
`lab/reports/analysis-v0.1/{gb1,aav}/conservation.*` 与其 figures、
`lab/reports/analysis-v0.1/conservation-report.md`。
...
- `lab/reports/analysis-v0.1/{gb1,aav}/conservation.json`(全精度)。
- `lab/reports/analysis-v0.1/{gb1,aav}/figures/conservation.png`。
- `lab/reports/analysis-v0.1/conservation-report.md` —— 方法、结果、**边界声明**。
