...
reports/final-report-v0.5/report.md；reports/final-report-v0.6/discussion_summary_and_epistemology.md与README.md、report.md（参考）；harness/reports/REPORT-HANDOFF.md；reports/v0.8-proposal-event-stream-reflexion.md；agent/pipeline.py、agent/llm.py、evolution/campaign.py、agent/auto_researcher.py；实际workflow-v1.1、analysis-v0.1及alpha扫描产物；scientific-writing规范。当前用户指令优先，参考稿数字按产物核实。
