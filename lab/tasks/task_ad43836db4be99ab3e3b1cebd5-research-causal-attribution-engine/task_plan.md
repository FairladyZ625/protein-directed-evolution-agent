...
4. `lab/context/research/plateau-breaking-methods.md`
...
- 产物写入：`lab/tasks/task_ad43836db4be99ab3e3b1cebd5-research-causal-attribution-engine/artifacts/`
...
- 交付物：`lab/tasks/task_ad43836db4be99ab3e3b1cebd5-research-causal-attribution-engine/artifacts/causal-attribution-engine-blueprint.md`
