...
- [定量报告](/Users/lizeyu/Projects/ai4s-directed-evolution-agent/.worktrees/t-mutation-order/lab/reports/analysis-v0.1/report.md)
- [测试](/Users/lizeyu/Projects/ai4s-directed-evolution-agent/.worktrees/t-mutation-order/tests/test_mutation_order.py)
- GB1/AAV 全精度 JSON 与图已写入 `lab/reports/analysis-v0.1/{gb1,aav}/`
