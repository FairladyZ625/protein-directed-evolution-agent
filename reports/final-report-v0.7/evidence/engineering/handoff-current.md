...
数据:`harness/reports/workflow-v1.1/gb1/campaign_llm.metrics.json`、
`harness/reports/workflow-v1.2/gb1/campaign_llm.metrics.json`(各 `strategies.<策略>.rounds[].n_nominated`)。
...
**完整证据:`harness/tasks/task_91e931121d3ae400a0a2be246b-v0-8-aav/artifacts/factorial-2x2-seed42.md`。
写这一节前先读它的第 ⑤ 节引用纪律。**
...
**完整证据:`harness/tasks/task_feb731c779788be5bfff65e979-v0-9/artifacts/contract-2x2-seed42.md`。
写这一节前先读它的第 ⑥ 节引用纪律。**
