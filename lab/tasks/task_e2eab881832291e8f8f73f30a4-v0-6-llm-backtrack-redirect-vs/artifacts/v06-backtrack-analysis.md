...
- `lab/reports/agentic-v0.4/aav/agentic.metrics.json` SHA256 `3f1fb10ba36a18287156f6e8dd52abb4d03a993d8c8656b87802ec49a3724612`
- `lab/reports/agentic-v0.4/aav/deterministic.metrics.json` SHA256 `41ae9945a401c0d047c7b6bd81738f96e953fa638bc55c5b22d1cae7e0e144b0`
- `lab/reports/agentic-v0.5/aav/agentic.metrics.json` SHA256 `a718c0b063bae3630812b606bfed5112556d595c08655f7e1bea89ee221d65ee`
...
reps={k:json.loads(Path(p).read_text()) for k,p in {
 'v4':'lab/reports/agentic-v0.4/aav/agentic.metrics.json',
 'det':'lab/reports/agentic-v0.4/aav/deterministic.metrics.json',
 'v5':'lab/reports/agentic-v0.5/aav/agentic.metrics.json'}.items()}
for version in ['v0.4','v0.5']:
    p=Path(f'lab/reports/agentic-{version}/aav/agentic.events.jsonl')
