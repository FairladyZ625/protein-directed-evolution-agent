...
交付 `harness/context/research/plateau-breaking-methods.md`:对"主动学习/定向进化撞上平台期时,真实蛋白工程科学家有哪些 answer-agnostic 破局手段"的文献调研,并把每个方法族映射回本题的笼子(池式、288 预算、in-silico 查表 oracle)判断能否落地。
