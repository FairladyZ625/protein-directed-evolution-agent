...
产物版本:`harness/reports/analysis-v0.1/`。分析线首版——**只读分析**,不跑新的虚拟进化实验,
...
- `harness/context/research/plateau-breaking-methods.md` §0(双因素机制,已按上述事实改写)
...
`harness/reports/analysis-v0.1/{gb1,aav}/mutation_order.*` 与其 figures、
`harness/reports/analysis-v0.1/report.md`。
...
- `harness/reports/analysis-v0.1/gb1/mutation_order.json` 与 `.../aav/mutation_order.json`。
- `harness/reports/analysis-v0.1/{gb1,aav}/figures/` 下的阶数对比图。
- `harness/reports/analysis-v0.1/report.md` —— 方法、四层结果、定量结论。
