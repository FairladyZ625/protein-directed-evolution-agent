...
LLM_TIMEOUT=60 OPENBLAS_NUM_THREADS=1 OMP_NUM_THREADS=1 VECLIB_MAXIMUM_THREADS=1 \
  ...
  --out-dir harness/reports/knowledge-ablation --seeds 0,1,2 --budget 48 --n-rounds 6
...
PYTHONPATH=. .venv/bin/python -c \
  "from events.store import EventStore; EventStore('harness/reports/knowledge-ablation/events.jsonl').verify(); print('event chain verified')"
```
