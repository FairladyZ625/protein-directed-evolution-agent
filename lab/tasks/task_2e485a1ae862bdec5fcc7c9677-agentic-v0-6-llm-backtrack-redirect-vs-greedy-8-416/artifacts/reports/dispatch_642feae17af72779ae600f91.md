...
**终态：两个变体 cum_top10_max 均 7.829、strong 命中 166(全版本最高)，未追平 8.416——但负结果的机制被完全钉死，并包含一个对任务前提的 evidence-backed 修正。** 本地 commit `471536b`,fact `F-72B1D940`,报告落 `lab/reports/agentic-v0.6/`。
