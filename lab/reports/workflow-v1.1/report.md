...
python evolution/campaign.py \
  --out-json lab/reports/workflow-v1.1/gb1/campaign_easy.metrics.json \
  --out-fig  lab/reports/workflow-v1.1/gb1/figures/campaign_easy.png \
  --out-events lab/reports/workflow-v1.1/gb1/campaign_easy.events.jsonl
...
每次运行会自动往 `lab/reports/experiment_log.jsonl` 追加一条带命令、git commit
