...
>
> 证据等级:标 ✔本仓已验证 的来自 `harness/facts/` 与 `harness/reports/agentic-v0.4/`;标(文献主张)的是外部论文结论,本会话未在本仓复现;引用核实状态见文末。检索由本 Agent 完成,综合判断供 CEO 裁定。
...
- ✔本仓事实:F-07B08C97(事件流诊断)、F-C08A6CF2(CV 0.898@alpha=100;3 折 CV 计算脚本未随仓提交,复算以已提交的 `analysis/epistasis_surrogate_scan.py` 输出为准)、`harness/reports/agentic-v0.4/report.md` 及 metrics/events JSON。
