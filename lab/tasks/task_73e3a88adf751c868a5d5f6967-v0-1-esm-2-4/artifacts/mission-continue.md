...
1. `lab/reports/analysis-v0.1/{gb1,aav}/conservation.json`(全精度)—— **没有**
2. `lab/reports/analysis-v0.1/{gb1,aav}/figures/conservation.png` —— **没有**
3. `lab/reports/analysis-v0.1/conservation-report.md` —— **没有**
...
`lab/reports/analysis-v0.1/{gb1,aav}/mutation_order.json`。其中有每个位置的效应信息
...
`lab/reports/analysis-v0.1/{gb1,aav}/conservation.*` 与 figures、`conservation-report.md`。
