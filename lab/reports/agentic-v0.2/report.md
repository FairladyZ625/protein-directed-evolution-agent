...
- 产物：`lab/reports/agentic-v0.2/aav/`（agentic.metrics.json + agentic.events.jsonl 链校验 + figures/agentic.png）；ledger `lab/reports/experiment_log.jsonl` 末条（git_commit + artifacts SHA256）。
